...
class ObservationsMap extends Component {
      ...
      return (
        ...
        >
          <div className="popup">
            ...
            <div>{`Sightings: ${popupInfo.counter}`}</div>
            <div>
              <img src={`${popupInfo.imageUrl}`} alt="Observation Image" />
            </div>
            <div>
  ...
  render() {
    ...
    let query = observations.reduce((accum, obs) => {
      if (!accum[obs.location] && obs.geog) {
        accum[obs.location] = {
    ...
    return (
      ...
      >
        ...
        <div className="mapKey">
          <div className="mapKey-title">{`Number of Sightings of ${
            observations[0].name
          }`}</div>
          <div>
